    ...
    <div class="container mt-3">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
            <div class="input-group flex-nowrap">
                ...
                <input type="text" name="apellidos" required class="form-control" placeholder="Apellidos" aria-label="Apellidos" aria-describedby="addon-wrapping">
            ...
            <div class="input-group flex-nowrap mt-2">
                ...
                <input type="email" name="email" required class="form-control" placeholder="Email" aria-label="Email" aria-describedby="addon-wrapping">
            </div>
            <div class="mt-2">
